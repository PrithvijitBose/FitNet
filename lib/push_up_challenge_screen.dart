...
class PushUpChallengeScreen extends StatefulWidget {
  ...
  PushUpChallengeScreen({required this.challenge});

  @override
  _PushUpChallengeScreenState createState() => _PushUpChallengeScreenState();
}

class _PushUpChallengeScreenState extends State<PushUpChallengeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.blueAccent, // Custom color for app bar
      ),
